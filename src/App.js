    ...
    return (
      <div className="main-container">
        <img
          ...
          className="logo"
        />
        <div className="new-psd-container">
          <img
            src="https://assets.ccbp.in/frontend/react-js/password-manager-sm-img.png"
            alt="password manager"
            className="psd-image"
          />
          <form className="psd-manager-container" onSubmit={this.addContent}>
            <h1 className="psd-title">Add New Password</h1>
          ...
          <img
            ...
            alt="password manager"
            className="psd-image-1"
          />
        </div>
        <div className="passwords-container">
          <div className="your-password">
            <div className="pwd">
              <h1 className="your-pwd-name">Your Passwords</h1>
              <p className="pwd-length">{newList.length}</p>
            </div>
          ...
          <div className="show-passwords">
            ...
            />
            <label htmlFor="check" className="label-pwd">
              Show Passwords
            </label>
          </div>
          {!isTrue && (
